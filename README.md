...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/OSjbgEp0MT)
...
```sh
npx nx serve rallia-app
```

To create a production bundle:

```sh
npx nx build rallia-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project rallia-app
```
